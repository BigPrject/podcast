function createSketch3() {
    return function(p) {
      ...
      p.preload = function() {
        song = p.loadSound('BellamyRD1.wav');
      };
  
      p.setup = function() {
        p.createCanvas(400, 400).parent('visualization3');
      ...
      p.draw = function() {
        p.background(0);
        p.stroke(0, 0, 255);  // Set stroke color to blue for differentiation
  ...
  let sketch3 = new p5(createSketch3());
